  ...
  return (
    ...
    >
      ...
      >
        ...
        <button onClick={onClose} className="absolute top-3 right-3 text-white hover:text-red-500 z-[9999] p-2 bg-gray-900 hover:bg-black rounded-full transition-all duration-200 shadow-xl border border-gray-700" aria-label="Fechar modal">
          <CloseIcon />
        </button>
