...
export type Page = 'explore' | 'create' | 'profile' | 'ranking' | 'map' | 'my-games' | 'community' | 'arenas' | 'match-chat' | 'notifications' | 'wallet' | 'invite' | 'settings' | 'support' | 'hire' | 'direct-chat';
