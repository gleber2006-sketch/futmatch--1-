    ...
    <div>
      ...
      {sortedAndFilteredMatches.length > 0 ? (
        ...
        <div className="text-center text-gray-400 p-8">
            <h3 className="text-xl font-semibold">Nenhuma partida encontrada</h3>
            <p className="mt-2">Tente ajustar seus filtros ou crie uma nova partida!</p>
        </div>
      )}
