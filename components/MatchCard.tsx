...
Bora jogar? 🚀`;
    ...
    return (
        ...
        ${match.is_private && !isCanceled ? 'bg-gradient-to-br from-purple-900/40 via-gray-800 to-gray-800' : !isCanceled ? 'bg-gradient-to-br from-green-900/25 via-gray-800 to-gray-800' : 'bg-gray-800'}
        ...
        ${!match.is_private && !isCanceled && !isBoosted ? 'border border-green-500/20 shadow-[0_0_8px_rgba(34,197,94,0.1)]' : ''}`}
