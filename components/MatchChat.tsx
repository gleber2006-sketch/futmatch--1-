...
const MatchChat: React.FC<MatchChatProps> = ({ currentUser, onNavigateBack, initialMatchId }) => {
  ...
  // VIEW: CHAT ROOM
  return (
    <div className="bg-gray-900 flex flex-col h-[calc(100vh-80px)]">
        {/* Header */}
        <div className="flex items-center bg-gray-800 p-4 shadow-md z-10">
            <button 
                onClick={() => { 
                    if (initialMatchId) {
        ...
        {/* Input Area */}
        <div className="p-3 bg-gray-800 border-t border-gray-700 pb-20 sm:pb-3">
