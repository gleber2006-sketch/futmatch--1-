...
const TeamInviteCard: React.FC<TeamInviteCardProps> = ({ team, inviteLink, onClose }) => {
    ...
    return (
        <div className="flex flex-col items-center animate-fade-in-up">
            {/* The Card */}
            <div className="relative w-full max-w-[320px] bg-gradient-to-br from-[#0a1628] to-[#112240] rounded-[2rem] p-8 border-2 border-green-500/30 shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden group">
